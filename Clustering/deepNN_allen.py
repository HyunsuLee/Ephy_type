...
with tf.name_scope('layer1'):
    Xavier_init = np.sqrt(2) * np.sqrt(2 / (43 + 43))
    W1 = tf.Variable(tf.truncated_normal([43, 43], stddev=Xavier_init), name='W1')
    b1 = tf.Variable(tf.random_normal([43]))
...
with tf.name_scope('layer2'):
    ...
    W2 = tf.Variable(tf.truncated_normal([43, 20], stddev=Xavier_init), name='W2')
...
with tf.name_scope('layer3'):
    ...
    W3 = tf.Variable(tf.truncated_normal([20, 10], stddev=Xavier_init), name='W3')
...
with tf.name_scope('output'):
    ...
    W4 = tf.Variable(tf.truncated_normal([10, 2], stddev=Xavier_init), name='W4')
...
log_path = '/180222dnn/LR_e-4_100000_dropout/'
