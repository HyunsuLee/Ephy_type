...
# testing 10 models, randomly assigned hyperparameter
# learning rate around 10e-3, L2 beta 10e-5 
# (results from 1st fine tuning) 
...
for model in range(total_model_test):
    LR_power = random.uniform(-3.5, -2.5)
    random_learning_rate = 10 ** LR_power
    
    beta_power = random.uniform(-5.5, -4.5)
